...
run londiste $v conf/londiste_db4.ini create-branch node4 'dbname=db4' --provider='dbname=db2'
run londiste $v conf/londiste_db5.ini create-branch node5 'dbname=db5' --provider='dbname=db2'
...
run londiste conf/londiste_db3.ini wait-sync

run londiste conf/londiste_db3.ini status

###################

#msg "Stop Londiste on Node2"
#run londiste conf/londiste_db2.ini worker -s
#sleep 1
...
run londiste conf/londiste_db1.ini worker -s
...
run londiste conf/londiste_db1.ini resurrect
